---
description: Changelog for Horizon v1.30.1. New features, changes, and bug fixes.
---

# Horizon 1.30.1

Download [here](https://horizn.moe/download.html?ver=v1.30.1).
...
- [CONTRIBUTING.md](https://github.com/Fchat-Horizon/Horizon/blob/development/CONTRIBUTING.md) has been updated to reflect the new build system
- [Build scripts](https://github.com/Fchat-Horizon/Horizon/tree/development/electron/release-scripts/) are now functionally more robust.
