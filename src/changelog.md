...
and this project adheres to [Semantic Versioning](https://semver.org/spec/v2.0.0.html). It is mirrored from the [main project's changelog.](https://github.com/Fchat-Horizon/Horizon/blob/main/CHANGELOG.md)
...
- Custom character colors! [[Commit](https://github.com/Fchat-Horizon/Horizon/commit/124ffbcaa8498d09a94323f1961eb173e5c5ab65)] [[Docs](/docs/features-overview.html#custom-character-colors-high-quality-portraits)]
